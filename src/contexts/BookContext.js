...
// DEFAULT VALULE METHOD





// 1-) Deafulst Value---> this.context: context i oluşturken varsayılan bir değer tanımlanacak  başlangıç değeri tanımlanacak 
// varsayılan değeri ilgili compenent da this.context ile ileteceğizz...

//* context nesnesini oluşturduk
//*baslangıc değeri verdik ve export ettik
//*ilgili componenta import ettik
//*contesxt type yardımıyla contexti ilgili componenta atadık
//*this.context type yardımıyla ilgili veriye ulaştık

// 2-) Provider-----> Consumer:  parent component içersinde provider componenetı oluşturup sonra göndermek istediğimiz veriyi
//  göndermek istediğimiz componentda consumer oluşturmak 
//* class componnet oluşturduk ve veriyi state içerisine koyduk
//*contexte ait provider ile state de bulunan veriyi aldık 
//* bu veriyi parent componenta bookcontextprovider yardımıyla gönderdik (parent child ilişkiisi{this.props.childirien})
// veriyi göndereceğimiz componeneta constext import ediyoruz
